const NoteComponent = ({ onClick, isExpanded, onExpandToggle }) => {
  return (
    <div 
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-sm" style={{ color: '#64748b' }}>August 29, 2025 15:55</span>
        </div>
        <button 
      ...
      <div className="px-4 py-3">
        <h3 className="text-lg font-semibold mb-2" style={{ color: '#1e293b' }}>
          ...
          <span className="ml-2 text-sm font-normal" style={{ color: '#64748b' }}>notes from tesla.com</span>
        </h3>
      </div>
      ...
      >
        <div className="p-4">
          <p className="text-sm mb-3" style={{ color: '#374151' }}>
            The new Model S Plaid acceleration is incredible - 0-60 in under 2 seconds. This could revolutionize our performance benchmarks.
          </p>
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              <span className="text-xs font-medium" style={{ color: '#64748b' }}>S</span>
              <span className="text-xs" style={{ color: '#64748b' }}>Sarah Chen</span>
              <span className="text-xs" style={{ color: '#9ca3af' }}>•</span>
              <span className="text-xs" style={{ color: '#9ca3af' }}>2 hours ago</span>
            </div>
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-1">
                <i className="ri-message-2-line text-xs" style={{ color: '#64748b' }}></i>
                <span className="text-xs" style={{ color: '#64748b' }}>3</span>
              </div>
              <div className="flex items-center space-x-1">
                <i className="ri-heart-line text-xs" style={{ color: '#64748b' }}></i>
                <span className="text-xs" style={{ color: '#64748b' }}>12</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="p-4">
          <p className="text-sm mb-3" style={{ color: '#374151' }}>
            Tesla's FSD Beta v12 neural network architecture is fascinating. The end-to-end approach might be the key to solving autonomous driving.
          </p>
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              <span className="text-xs font-medium" style={{ color: '#64748b' }}>M</span>
              <span className="text-xs" style={{ color: '#64748b' }}>Mike Rodriguez</span>
              <span className="text-xs" style={{ color: '#9ca3af' }}>•</span>
              <span className="text-xs" style={{ color: '#9ca3af' }}>4 hours ago</span>
            </div>
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-1">
                <i className="ri-message-2-line text-xs" style={{ color: '#64748b' }}></i>
              ...
              <div className="flex items-center space-x-1">
                <i className="ri-heart-line text-xs" style={{ color: '#64748b' }}></i>
                <span className="text-xs" style={{ color: '#64748b' }}>24</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="p-4">
          <p className="text-sm mb-3" style={{ color: '#374151' }}>
            Supercharger V4 deployment strategy looks promising. 350kW charging will make long-distance EV travel seamless.
          </p>
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              <span className="text-xs font-medium" style={{ color: '#64748b' }}>E</span>
              <span className="text-xs" style={{ color: '#64748b' }}>Emma Watson</span>
              <span className="text-xs" style={{ color: '#9ca3af' }}>•</span>
              <span className="text-xs" style={{ color: '#9ca3af' }}>1 day ago</span>
            </div>
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-1">
                <i className="ri-message-2-line text-xs" style={{ color: '#64748b' }}></i>
                <span className="text-xs" style={{ color: '#64748b' }}>5</span>
              </div>
              <div className="flex items-center space-x-1">
                <i className="ri-heart-line text-xs" style={{ color: '#64748b' }}></i>
                <span className="text-xs" style={{ color: '#64748b' }}>18</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="p-4">
          <p className="text-sm mb-3" style={{ color: '#374151' }}>
            The Cybertruck production timeline update shows they're finally scaling. This could disrupt the entire pickup truck market.
          </p>
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              <span className="text-xs font-medium" style={{ color: '#64748b' }}>D</span>
              <span className="text-xs" style={{ color: '#64748b' }}>David Kim</span>
              <span className="text-xs" style={{ color: '#9ca3af' }}>•</span>
