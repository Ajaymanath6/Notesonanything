...
// Dashboard Expand Component - Multi-Site Layout with Better Space Utilization
const DashboardExpand = ({ userNotes = [] }) => {
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-3">
              ...
              <h2 className="text-xl font-bold" style={{ color: '#1e293b' }}>Multi-Site Dashboard</h2>
            </div>
...
export default DashboardExpand;
