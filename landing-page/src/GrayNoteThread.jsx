...
// Gray-themed Thread Note Component with Comments
const GrayNoteThread = ({ 
  content = "",
  author = "You",
  avatar = "YO",
  timestamp = "just now",
  ...
  return (
    ...
    >
      ...
      <div className="bg-white rounded-3xl  border border-gray-200 backdrop-blur-xl w-[320px] overflow-hidden">
        ...
        {/* Note Content Area with Gray Theme */}
        <div 
          className="p-4"
            ...
            <div className="relative">
              <textarea
                ...
                style={{ 
                  ...
                  borderColor: isOverLimit ? '#FCA5A5' : 'rgba(0, 0, 0, 0.2)'
                }}
                disabled={isSaving}
              />
        ...
        {/* Comments Section with Gray Theme */}
        {!isEditing && (
          <div 
            className="border-t"
            style={{ 
          ...
          >
            ...
            <div className="px-4 py-3 border-b" style={{ borderBottomColor: 'rgba(0, 0, 0, 0.05)' }}>
              <div className="flex items-center space-x-2">
                    ...
                    <div className="flex-1 space-y-2">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          ...
                          style={{ 
                            backgroundColor: newComment.trim() && !isSubmitting ? '#4A4A4A' : '#9CA3AF'
                          }}
                        >
                          {isSubmitting ? (
                            <motion.div
...
// Gray-themed Comment Item Component
  ...
  return (
    ...
    >
      <div className="flex items-start justify-between">
        <div className="flex items-center space-x-2">
          ...
          <div>
            ...
            <span className="text-xs ml-2 text-gray-600">{comment.timestamp}</span>
          </div>
        </div>
        {isOwner && (
          <button
        ...
        <div className="flex items-center space-x-4">
          <button
            ...
            className={`flex items-center space-x-1 text-xs transition-colors ${
              isLiked ? 'text-gray-800 opacity-100' : 'text-gray-600 opacity-70 hover:opacity-100'
            }`}
          >
          ...
          <button
            ...
            className="flex items-center space-x-1 text-xs text-gray-600 opacity-70 hover:opacity-100 transition-colors"
          >
      ...
      {comment.replies && comment.replies.length > 0 && (
        <div className="ml-4 space-y-2 border-l-2 pl-3" style={{ borderLeftColor: 'rgba(0, 0, 0, 0.1)' }}>
